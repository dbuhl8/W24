...
program shearSolve
    ...
    integer, parameter :: M = 50, Nmax = 20, nk = 20, nkx = 1
...
!   open(10, file="kz"//trim(str(Nmax))//".dat")
!       do i = 1, nk
!          write (10, *) kz(i, 1) 
!       end do
!   close(10)
!   open(11, file="kx"//trim(str(Nmax))//".dat")
!       do i = 1, nk
!          write (11, *) kx(i, 1) 
!       end do
!   close(11)
!   open(12, file="lambda"//trim(str(Nmax))//".dat")
!       do i = 1, nk
!          write (12, *) lambda(i, :)
!       end do
!   close(12)
!   open(13, file="nk"//trim(str(Nmax))//".dat")
!       write (13, *) nk
!   close(13)
